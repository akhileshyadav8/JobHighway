        ...
        <div className="mb-10 space-y-4">
          ...
          <div className="relative max-w-md mx-auto">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-teal-500/30 shadow-2xs"
            />
            {searchQuery && (
              <button
        ...
        {filteredArticles.length === 0 ? (
          <div className="text-center py-16 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-8">
            ...
            <button
              ...
              className="text-xs font-semibold text-teal-600 dark:text-teal-400 underline hover:no-underline"
            >
              Reset Filters
            </button>
          </div>
