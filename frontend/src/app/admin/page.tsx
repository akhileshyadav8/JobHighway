      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white border border-slate-200/90 rounded-xl p-5 shadow-2xs">
          <div className="flex items-center justify-between mb-2">
            ...
            <Link href="/admin/analytics/jobs" className="text-xs font-semibold text-teal-600 hover:underline">
              Inspect
            </Link>
          </div>
        ...
        <div className="bg-white border border-slate-200/90 rounded-xl p-5 shadow-2xs">
          <div className="flex items-center justify-between mb-2">
            ...
            <Link href="/admin/analytics/traffic" className="text-xs font-semibold text-teal-600 hover:underline">
              Inspect
            </Link>
          </div>
        ...
        <div className="bg-white border border-slate-200/90 rounded-xl p-5 shadow-2xs flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-100">
              ...
              <Link href="/admin/sources" className="text-xs font-semibold text-teal-600 hover:underline">
                View All
              </Link>
            </div>
