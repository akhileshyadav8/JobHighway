  ...
  return (
    <div className="min-h-screen bg-slate-50 py-10 sm:py-12">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="bg-white text-slate-900 rounded-2xl p-6 sm:p-7 mb-8 shadow-xs border border-slate-200/90 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2.5">
            <Button
              ...
              variant="outline"
              size="sm"
              className="text-xs bg-white border-slate-300 hover:bg-slate-50 text-slate-700 rounded-md cursor-pointer shadow-2xs font-semibold"
            >
            ...
            <Button
              ...
              size="sm"
              variant="ghost"
              className="text-xs text-rose-600 hover:bg-rose-50 hover:text-rose-700 rounded-md cursor-pointer font-semibold"
            >
              Sign Out
            </Button>
          </div>
        ...
        {/* Quick Nav Tabs */}
        <div className="flex items-center gap-6 sm:gap-8 border-b border-slate-200 mb-8 overflow-x-auto pb-0">
          <button
            onClick={() => setActiveTab("telemetry")}
            className={`pb-3 text-xs sm:text-sm font-medium transition-colors cursor-pointer flex items-center gap-2 border-b-2 -mb-px whitespace-nowrap ${
              activeTab === "telemetry"
          ...
          <div className="space-y-6">
            ...
            {selectedCandidate && (
              <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
                <Card className="max-w-2xl w-full max-h-[85vh] flex flex-col bg-white border-slate-200 rounded-xl shadow-xl overflow-hidden animate-in zoom-in-95 duration-150">
                  ...
                  <CardContent className="p-6 space-y-4">
                    ...
                    <div className="pt-4 border-t border-slate-100 flex items-center gap-3">
                      <a
                        ...
                        className="px-4 py-2 rounded-lg bg-teal-600 hover:bg-teal-700 text-white font-semibold text-xs inline-flex items-center gap-1.5"
                      >
